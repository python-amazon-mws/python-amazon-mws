...
class OrdersTestCase(CommonAPIRequestTools, unittest.TestCase):
    ...
    def test_list_orders(self):
        ...
        self.assertEqual(params["CreatedAfter"], created_after.isoformat())
        self.assertEqual(params["CreatedBefore"], created_before.isoformat())
        ...
        self.assertEqual(params["BuyerEmail"], "dudley.do.right@example.com")
